  ...
  "arrival": [
    {
      ...
      caption:
        "HEVRON's Sloan vest and Alina pant in ivory linen, a beige linen blazer left open, and warm tan leather — the polished ivory arrival, walked slowly up from the harbor.",
      image: arrivalIvorySplendidoImage.url,
      alt: "Lilla in Portofino in an ivory linen vest and matching ivory wide-leg linen trousers with a beige linen blazer worn open, tan leather sandals, a raffia and leather tote, tortoise sunglasses and sculptural gold jewelry.",
      reference: {
        slot: "Hero Piece · Vest",
        brand: "HEVRON",
        name: "Sloan Linen Vest",
        color: "Ivory",
        price: "$265",
        retailer: "Revolve",
      ...
      shop: {
        stylingNote:
          "Ivory linen tailoring worn as a set under an open beige blazer, warmed with tan leather and one gold family — polished arrival dressing with room to move.",
        products: [
          {
            slot: "Hero Piece · Trousers",
            brand: "HEVRON",
            name: "Alina Pant — Ivory (wide-leg linen)",
            price: "$438",
          ...
          },
          {
            ...
            name: "x REVOLVE Krista Linen Blazer — Beige",
            price: "$218",
          ...
          },
          {
            slot: "Bag",
            brand: "florabella",
            name: "Antilles Crochet Raffia And Leather Tote Bag — Frappe",
            price: "$242",
          ...
          },
          {
            slot: "Sunglasses",
            brand: "Chimi",
            name: "Sally Sunglasses — Lica Tortoise",
            price: "$240",
          ...
          },
          {
            slot: "Necklace",
            brand: "Missoma",
            name: "Lucy Williams Engravable Roman Arc Coin Necklace — 18ct Gold Plated",
            price: "$213",
