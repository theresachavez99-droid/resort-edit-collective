...
export const brandCategories: BrandCategory[] = [
  ...
  },
  {
    ...
    brands: [
      ...
      b("Bond-Eye", "Australian recycled-knit minimalism.", { resortEditLoves: ["Minimalist swim"] }),
  ...
  },
  {
    ...
    brands: [
      ...
      b("Camilla", "Sydney kaftans, kaleidoscopic and unmistakable.", { resortEditLoves: ["Embellished kaftans"] }),
  ...
  },
  {
    ...
    brands: [
      ...
      b("Manolo Blahnik", "The Capri sandal, the Riviera heel.", { bestFor: ["Riviera Dinner"] }),
