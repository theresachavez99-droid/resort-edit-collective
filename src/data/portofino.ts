...
export const portofinoLooks: Look[] = [
  ...
  },
  {
    ...
    shop: [
      {
        brand: "Posse",
        item: "Stripe Linen Shirt",
        price: "$229",
        href: "https://possethelabel.com",
        inventory_status: "in_stock",
        last_verified_date: "2026-05-29",
      },
      {
