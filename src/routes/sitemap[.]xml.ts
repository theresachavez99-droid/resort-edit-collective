...
/**
 * Canonical live pages ONLY. Redirected routes (/latest, /brands, /my-edit,
 * /pack-my-trip, legacy Portofino moment URLs), unpublished destination pages
 * and every /admin surface are deliberately excluded.
 */
const ENTRIES: SitemapEntry[] = [
  ...
  { path: "/privacy-rights", changefreq: "yearly", priority: "0.3" },
];
