  ...
  return (
    <div id="experiences" className="scroll-mt-24">
      ...
      <p className="mt-4 font-serif italic text-[0.82rem] text-ink/55 leading-relaxed max-w-3xl">
        Details above are taken from each operator's own page and checked by hand. Availability and terms are set by the
        operator — some experiences are arranged by enquiry rather than instant booking.
      </p>
    </div>
  );
}
